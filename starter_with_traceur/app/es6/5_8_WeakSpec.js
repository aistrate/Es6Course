describe("WeakSet", function() {
    ...
    //// set.clear() does not exist in Chrome; it does exist in Firefox
...
describe("WeakMap", function() {
    ...
    it("should be able to determine existence of items with has", function() {
    ...
    //// map.clear() does not exist in Chrome; it does exist in Firefox
